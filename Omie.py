...
class Omie:
    def __init__(self, empresa):
        ...
        self.ConsultarProduto = OmieConsultarProduto(empresa)
...
class OmieConsultarProduto:
    def __init__(self, empresa):
        self.empresa = empresa
        self.caminho = "geral/produtos/"
        self.call = "ConsultarProduto"
        self.codigo_produto = ""  # Corrigir a atribuição correta aqui
        self.codigo_produto_integracao = ""
        self.codigo = ""  # Atribuir valor para o atributo 'codigo'
...
class OmieListarDocumentos:
    def __init__(self, empresa):
        ...
        self.nRegPorPagina = 100
        self.cModelo: "55"
        self.dEmiInicial: "1"  # valor ilustrativo
        self.dEmiFinal: "2"  # valor ilustrativo
        # self.apenas_importado_api = "N"
...
class OmieApi:
    ...
    def key(self):
        return os.getenv(self.empresa + '_KEY')

    def secret(self):
        return os.getenv(self.empresa + '_SECRET')

    def cliente_imposto(self):
        return os.getenv(self.empresa + '_CLIENTE_IMPOSTO')

    def cenario_imposto(self):
        return os.getenv(self.empresa + '_CENARIO_IMPOSTO')

    def local_de_estoque(self):
        return os.getenv(self.empresa + '_LOCAL_DE_ESTOQUE')
